...
import { DOCS_URL } from "constants/Project";
...
type HeaderProps = {
  actions?: ReactNode;
  /** Toolbar-only mode for the NexusPanel shell layout */
  compact?: boolean;
};
const iconProps = {
  baseStyle: {
...
const NOTIFICATION_KEY = "nexuspanel-menu-notification";
...
export const Header: FC<HeaderProps> = ({ actions, compact }) => {
            ...
            <MenuList minW="170px" zIndex={99999} className="menuList">
              ...
              {DOCS_URL && (
                <Link to={DOCS_URL} target="_blank">
                  <MenuItem maxW="170px" fontSize="sm" icon={<DonationIcon />}>
